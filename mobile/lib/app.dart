...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/home',
        builder: (_, __) => const MainShell(navIndex: 0, child: HomeScreen()),
      ),
      GoRoute(
        path: '/orders',
        builder: (_, __) => const MainShell(navIndex: 1, child: OrderListScreen()),
      ),
      GoRoute(
        path: '/profile',
        builder: (_, __) => const MainShell(navIndex: 2, child: ProfileScreen()),
      ),
      GoRoute(
        path: '/login',
        builder: (_, __) => const MainShell(navIndex: 2, child: LoginScreen()),
      ),
      GoRoute(
        path: '/register',
        builder: (_, __) => const MainShell(navIndex: 2, child: RegisterScreen()),
      ),
      GoRoute(
        path: '/products',
